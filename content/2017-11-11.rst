...
- Small (7%) performance increase in metaball tessilation
...
- Small speedup for viewport data cacheing (60% improvement)
...
- Optionally cancel render when a texture is missing
  :diff:`2908`
- Simplify optimization for finding unique ID names (42% speed improvement)
  :diff:`2909`
- Experimental hashing lookup of ID's (14x speed improvement)
  :diff:`2910`
